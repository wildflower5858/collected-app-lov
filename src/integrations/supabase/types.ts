  ...
  public: {
    Tables: {
      binders: {
        ...
        Relationships: [
          {
            foreignKeyName: "binders_group_id_fkey"
            columns: ["group_id"]
            isOneToOne: false
      ...
      kpop_cards: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "kpop_cards_parallel_id_fkey"
            columns: ["parallel_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "kpop_cards_set_id_fkey"
            columns: ["set_id"]
            isOneToOne: false
      ...
      pokemon_cards: {
        ...
        Relationships: [
          {
            foreignKeyName: "pokemon_cards_parallel_id_fkey"
            columns: ["parallel_id"]
            isOneToOne: false
            referencedRelation: "parallels"
            referencedColumns: ["id"]
